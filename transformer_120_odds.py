...
class BoatTransformer(tf.keras.Model):
    ...
    def __init__(self):
        ...
        #self.output_layer = layers.Dense(120+1, activation='softmax')
        self.output_layer = layers.Dense(120+1, activation='relu')
