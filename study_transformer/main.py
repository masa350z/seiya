...
class RacersEncoder(tf.keras.Model):
    def __init__(self, num_layers, d_model, num_heads, dff, input_vocab_size,
                 output_size, pe_input, rate=0.1):
        super(RacersEncoder, self).__init__()
...
# %%
posi = positional_encoding(6, 128)
posi
# %%
q = tf.constant([[[3.0,2.0,3.0],[1.0,4.0,3.0],[6.0,2.0,3.0]],
                 [[4.0,1.0,3.0],[5.0,2.0,3.0],[1.0,1.0,3.0]]])
k = q
v = q
...
maximum_position_encoding: シーケンスの最大長
"""
sample_encoder = Encoder(num_layers=2, d_model=512, num_heads=8, 
                         dff=2048, input_vocab_size=8500,
                         maximum_position_encoding=10000)
temp_input = tf.random.uniform((64, 6), dtype=tf.int64, minval=0, maxval=200)
