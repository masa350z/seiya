...
print(racedata.get_preinfo())
print(racedata.get_grade_shouritsu_exinfo())
print(racedata.get_computer_prediction())
print(racedata.get_sanrentan_odds())
print(racedata.get_sanrenpuku_odds())
print(racedata.get_nirentan_puku_odds())
print(racedata.get_kakurenpuku_odds())
print(racedata.get_tansho_hukusho_odds())
# %%
