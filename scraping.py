...
preinfo = racedata.get_preinfo()
grade_shouritsu_exinfo = racedata.get_grade_shouritsu_exinfo()
computer_prediction = racedata.get_computer_prediction()
sanrentan_odds, sanrentan_num = racedata.get_sanrentan_odds()
sanrenpuku_odds, sanrenpuku_num = racedata.get_sanrenpuku_odds()
nirentan_odds, nirenpuku_odds, \
    nirentan_num, nirenpuku_num = racedata.get_nirentan_puku_odds()
kakurenpuku_odds, kakurenpuku_num = racedata.get_kakurenpuku_odds()
tansho_odds, fukusho_odds, tanpuku_num = racedata.get_tansho_fukusho_odds()
# %%
race_num_df = pd.DataFrame([inpdate], columns=['race_num'])
